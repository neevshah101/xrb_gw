...
GW190814, a merger involving a $23\,\Mdot$ black hole and a $2.6\,\Mdot$ compact object is the most asymmetric GW event till date ($q\approx 0.1$). % in the hypothesized “lower-mass-gap” between neutron stars (NS) and black holes (BH).
 ...
 %We demonstrate how local electromagnetic observations of intermediate stages of massive binary evolution can be utilized to understand rare outcomes such as GWs, particularly the “outliers” among them. 
 To understand the formation pathway of GW190814, we leverage local observations of an analogous runaway high-mass X-ray binary (HMXB) 4U 1700-37, in our own Galaxy, consisting of a $\approx 2\,\Mdot$ compact object and a $40-50\,\Mdot$ supergiant companion. Constrained by observables such as its orbital properties, kinematics, and local environment, we use Monte-Carlo simulations to reconstruct the HMXB pre-supernova. We also compute detailed binary evolution models with \textsc{MESA} to explain the evolutionary history of this system. We find that conservative mass transfer (MT) in a short period binary, along with a directed natal kick are necessary to explain its current state. We also show that this HMXB is unlikely to form a GW source due to a failed Common Envelope (CE) phase in the future. By computing additional models at lower metallicity, we demonstrate that a similar pathway can naturally form GW190814-like events. Conservative MT significantly inverts the mass--ratio of the binary, and the first born compact object is a NS or low-mass BH. If it receives a strong natal kick that widens the orbit post-supernova, the subsequent interaction occurs when the companion star develops a loosely bound convective envelope. This leads to a successful CE phase and eventually forms a highly asymmetric mass--ratio compact binary like GW190814. Our estimated rates of such GW events are within an order of magnitude of the observed rates. %This study highlights the importance of the interplay between finding, and characterizing, rare and common products of massive binary evolution with various surveys in the local universe, and using them as a bridge to understand the formation of GW sources.
