...
\end{figure}
 ...
 This back--of--the--envelope estimate is consistent with the $\rm 1-23\, Gpc^{-3} yr^{-1}$ rate of GW190814--like events estimate by the LVK collaboration, which is based on a single event (GW190814), and is a poisson rate. However, a detailed rate caclulation requires the use of population--synthesis techniques to account for the star formation history, metallicity dependence, and other uncertainties in linking Galactic HMXBs to GW events, which we defer to future work.
