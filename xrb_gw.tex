...
\author[orcid=0000-0002-8465-8090,sname='North America']{Mathieu Renzo}
\affiliation{Department of Astrnomy \& Steward Observatory, The University of Arizona}
\email{mrenzo@arizona.edu}

\author[orcid=0000-0002-8465-8090,sname='North America']{Koushik Sen}
\affiliation{Department of Astrnomy \& Steward Observatory, The University of Arizona}
\email{ksen@arizona.edu}

\author[orcid=0000-0002-8465-8090,sname='North America']{Aldana Grichener}
\affiliation{Department of Astrnomy \& Steward Observatory, The University of Arizona}
...
\red{The catalog of Gravitational Wave (GW) events is rapidly growing}, \blue{providing key insights into the evolution of massive binaries and compact object formation}. \orange{However, the origin of exceptional events such as GW190814, the most asymmetric mass--ratio merger to date ($q\approx 0.1$) remain challenging to explain.} \magenta{Given its mass ratio, we show that it shares a evolutionary pathway with the High Mass X-ray Binary (HMXB) 4U 1700-37/ HD 153919, the most unequal mass Galactic HMXB. We demonstrate this unique connection by utilizing a rich set of observational constraints that exist for the HMXB.} \brown{We compute detailed binary evolution models to explain its formation history and find that conservative mass transfer, along with a directed natal kick are essential to explain its current state. We also show that this system is unlikely to form a GW source due to a failed Common Envelope (CE) phase in the future. We compute another set of models to demonstrate scenarios where a similar pathway naturally forms asymmetric mass--ratio GW events such as GW190814. The first phase of mass transfer remains conservative, and the first--born compact object must receive a large natal kick ($\gtrsim 100\,\mathrm{km/s}$) for the subsequent CE phase to be successful and form a asymmetric mass--ratio GW source. Anchored by the number of analogous HMXBs in the Galaxy, we estimate
rates for such GW events, which are in agreement with their observed rate.} \grey{Our work highlights the critical role of finding and characterizing local analogous systems in different evolutionary phases, and using them as a bridge to understand the origin of GW sources, especially the outliers such as GW190814.} Massive binaries, which are the progenitors of GWs and HMXBs have a wide-ranging impact in several fields, and such rigorous studies provide a benchmark for constraining key uncertainties in their evolution.
...
More recently, astrometry with Gaia, and other radial velocity surveys have unraveled a small but growing population of non--interacting binaries that contain a compact object such as a BH \citep[e.g,][]{2023MNRAS.518.1057E,2023MNRAS.521.4323E,2024A&A...686L...2G} or NS \citep{2024OJAp....7E..58E}. Additionally, a handful of binary neutron star (BNS) systems have been observed in the Galaxy through pulsar observations \citep[e.g,][]{2003Natur.426..531B}. 
...
\cite[e.g.,][]{2020ApJ...899L...1Z, 2025arXiv251116648M}. The observed rate of highly asymmetric GW events may also include contributions from other formation scenarios, both within the context of isolated binary evolution, as well as other pathways such as dynamical interactions or triples.
 ...
 \begin{figure}[htbp]
    ...
    \caption{The top panel shows the distribution of post--SN Roche Lobe sizes for our
fiducial model for the formation of a GW190814--like system, where we
have assumed the natal kicks to follow a lognormal distribution \citep{2025ApJ...989L...8D}. The yellow band corresponds to
...
source in the future due to a failed CE phase. The purple band corresponds to post--SN
...
source like GW190814. The blue band denotes orbits that are large enough such that the star does not fill its Roche Lobe during its subsequent evolution. The top axis denotes the corresponding orbital separation, for the assumed mass--ratio of $q \approx 1/14$. The bottom panel shows the distribution of natal kicks for a successful CE phase (in purple), while the assumed prior is shown in dotted black.}
    \label{fig:gw_post_SN_rl}
\end{figure}

\section{Discussion} \label{sec:discussion}

In this section we discuss additional observational constraints for the HMXB 4U 1700-37/ HD 153919, and certain assumptions and caveats for our corresponding models. Additionally, we discuss the explodability of the first--born compact object, the stability of the second phase of mass transfer and the expected spins of the massive BH in our models for GW190814. We also compare our results to previous studies that explored the origin of GW190814--like events.
...
\begin{enumerate}
    ...
    \item \textit{Smaller initial accretor mass:} This would imply a smaller mass for the star post--SN, increasing its MS lifetime. However, this could be in tension with the estimated luminosity and mass of the companion star, as we find that (initially) lower mass accretors are less luminous and less massive at present day than what is inferred from observations.
...
In both scenarios, we require that the donor star in the binary successfully explodes at the end of its life, and leaves behind a
...
lost through winds or binary interactions. While various 3D simulations of core--collapse SNe are
...
\citep{2020ApJ...899L...1Z} found two potential scenarios for forming
...
Gravitational Wave events are some of the most exotic products of massive binary evolution. Understanding how these sources form is a key goal for studies of massive (and binary) star evolution. However, the masses and spins of the compact objects as inferred from the GW data are often insufficient to infer their origins. This is particularly relevant for the exceptional GW events that may be outliers to the rest of the GW population. Often, it can be extremely beneficial to take a step back, and understand the origins of the numerous intermediate stages in the evolution of massive stars in binaries. Such systems abound in the local Universe, such as Algols, WR+O systems, HXMBs, DNSs and others. They offer a wealth of observational constraints that can be utilized to understand their evolutionary history, which are inaccessible when solely studying GW sources. 

We demonstrate this approach for GW190814, which, with a $q \approx 0.1$ remains the most asymmetric mass--ratio compact binary merger observed by the LVK detectors. Although there have been several proposed formation pathways for this event, its origin remains unclear. 

We leverage the highly asymmetric mass--ratio Galactic HMXB 4U 1700-37, and utilize several observables such as its orbital properties, kinematics, and local environment to reconstruct its evolutionary history with the help of Monte Carlo simulations and detailed binary evolution models. We found that conservative mass transfer on the MS is crucial to invert the mass--ratio of the binary, and a directed natal kick is required to explain its current orbit. We also showed that this Galactic HMXB is unlikely to form a potential GW source in the future, and the binary will prematurely merge in a potential CE phase in the near future. Although not a GW source \red{for the ground--based detectors}, this could appear as a transient or even form a T\.ZO.

However, we computed another set of binary evolution models to show how a similar evolutionary pathway can also form asymmetric mass--ratio GW sources. The first phase of mass transfer remains stable and conservative, which significantly inverts the system mass--ratio. In such situations, the lower mass compact object, which could be a NS or a low mass BH forms first. We find that the subsequent CE phase can be successful if the companion star fill its Roche--Lobe when it is on the RSG branch with a loosely bound convective envelope. This requires the orbital separation post--SN to be relatively large, which implies that the first born compact object, regardless of whether it is a NS or a BH, receives a strong natal kick ($\gtrsim 100\,\mathrm{km/s}$). The CE phase significantly hardens the binary, and the remnant core of the companion star eventually implodes to form a massive BH. The subsequent evolution is dominated by a GW--driven inspiral, and ends in a compact binary coalescense that would appear as a highly asymmetric mass--ratio GW source like GW190814 to the LVK detectors.

Utilizing the fact that there exist two highly asymmetric Galactic HMXBs, we also estimate the local rate of highly asymmetric GW190814--like events to be $\approx 0.5\,\mathrm{Gpc}^{-3}yr^{-1}$, which is in agreement with their observed rate.
