...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{gw_hr_accretor.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{gw_fiducial_be_radius.pdf}
...
\subsection{Kinematic age of the HMXB 4U 1700-37}
...
\subsection{Rotational Velocity of HD 153919}
...
\subsection{Does the HMXB 4U 1700-37 need to form through Case A mass transfer?}
...
\begin{figure}
\gridline{\fig{xrb_hr_resolution_test.pdf}{0.5\textwidth}{(a)}
\fig{gw_hr_resolution_test.pdf}{0.5\textwidth}{(b)}}
