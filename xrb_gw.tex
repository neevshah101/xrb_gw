...
$2.6\,\Mdot$ secondary in GW190814. Although we stop the evolution
at core helium depletion, we discuss ``explodability'' in Sec.~\ref{sec:explodability}. The compact object may also
...
should be said explicitly!} \red{I've discussed the spin in the Discussion}
