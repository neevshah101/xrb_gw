...
(ZAMS), but this can change due to tidal effects or the gain/ loss of angular momentum. We include several
...
Once the companion star in the HMXB 4U 1700-37 fills its Roche Lobe, it will start transferring mass onto the compact object. However, given the highly asymmetric mass ratio of the system ($q \approx 1/20$), this is likely to become unstable. We find that the mass transfer rate exceeds $0.1 \, \Mdot/\mathrm{yr}$, which generally signifies the onset of dynamical instability \citep{2025arXiv251009745K}. We assume such systems to undergo a Common Envelope (CE) phase \citep{Fragos23_posydon}. For an alternative scenario see Section \ref{stable}. 
...
To evaluate the outcome of the CE phase in the HMXB 4U 1700-37, we use our treatment of CE
evolution described above. We save the internal structure of the
companion star at the onset of RLOF, and compute the binding energy of
its envelope. The star is still on the MS at that
...
The progenitor binaries of the GW events detected by the LVK formed when the universe was much younger, and therefore metal--poor.
...
To account for the different possible outcomes post--SN, we ``detach" the companion star from the compact object, and follow its evolution as a single star in \textsc{MESA}. This allows us to model the evolution of its density structure and envelope binding energy along with its radial evolution, thereby accounting for different possible post--SN orbital separations and their outcomes.
...
RL sizes after the first--SN. We have assumed that a $12.7\,\Mdot$
...
low mass compact object which could either be a NS or a low mass BH. Observations of the Galactic HMXB 4U 1700-37 strongly suggest that this pathway can occur in nature, as this system consists of a low mass compact object with a massive stellar companion.
...
occured after the MS of the donor, i.e Case B. %\mr{Explain that this requires a larger initial period} \red{its mentioned a couple of sentences below} 
