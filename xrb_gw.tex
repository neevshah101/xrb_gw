...
\begin{figure}[htbp]
    ...
    \caption{The evolution of the donor (top panel) and accretor star (bottom panel)on the HR diagram, in our fiducial model for forming the HMXB 4U 1700-37/ HD 153919 at $Z = Z_\odot = 0.0146$. The initial masses of the donor and accretor are $40\,\Mdot$ and $28\,\Mdot$, and the initial orbital period is $3\,\mathrm{days}$. The blue  and red curves highlight fast and slow Case A mass transfer respectively, while the green curve is for Case AB. The diamond, plus, and star markers correspond to the TAMS, core--helium ignition, and core--helium depletion respectively. The purple and blue markers with errorbars show the observed location of HD 153919 from \cite{2020A&A...634A..49H} and \cite{2021A&A...655A..31V} respectively. The inset panel zooms into the evolution of the donor during Case A mass transfer.}
...
models at solar metallicity to demonstrate the past evolutionary history of the most asymmetric HMXB in the Galaxy. However, we also showed that it is unlikely to lead to the formation of a highly asymmetric GW source, as the system is likely to merge in a future CE phase due to the star's high envelope binding energy. This motivates us to compute another set of detailed binary evolution models, and explore scenarios in which a CE phase is successful, and leads to the formation of a highly asymmetric GW source such as GW190814.
...
converging on the imporance of the neutrino--driven convection in
 driving successful explosions \citep[e.g,][]{2025arXiv250214836J}, they are
